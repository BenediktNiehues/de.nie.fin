 ...
 * <ul>
 *   <li>{@link de.nie.fin.fin.impl.KategorieImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class KategorieImpl extends ElementImpl implements Kategorie
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FinPackage.KATEGORIE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FinPackage.KATEGORIE__NAME:
        return getName();
    }
