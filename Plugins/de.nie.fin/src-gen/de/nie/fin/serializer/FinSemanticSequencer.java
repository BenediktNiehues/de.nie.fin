...
public class FinSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private FinGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == FinPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case FinPackage.BUCHUNG:
				if(context == grammarAccess.getBuchungRule() ||
				   context == grammarAccess.getElementRule()) {
					sequence_Buchung(context, (Buchung) semanticObject); 
					return; 
				}
				else break;
			case FinPackage.BUCHUNGSINTERVALL:
				if(context == grammarAccess.getBuchungsintervallRule() ||
				   context == grammarAccess.getElementRule()) {
					sequence_Buchungsintervall(context, (Buchungsintervall) semanticObject); 
					return; 
				}
				else break;
			...
			case FinPackage.KONTO:
				if(context == grammarAccess.getElementRule() ||
				   context == grammarAccess.getKontoRule()) {
					sequence_Konto(context, (Konto) semanticObject); 
					return; 
				}
				else break;
			}
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName? imports+=Import* elements+=Element*)
	 */
	protected void sequence_FinModelFile(EObject context, FinModelFile semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, FinPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, FinPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
