		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBuchungAccess().getAlternatives(), "rule__Buchung__Alternatives");
					put(grammarAccess.getBuchungAccess().getAlternatives_0_7(), "rule__Buchung__Alternatives_0_7");
					...
					put(grammarAccess.getIntervallAccess().getGroup_4(), "rule__Intervall__Group_4__0");
					put(grammarAccess.getKategorieAccess().getGroup(), "rule__Kategorie__Group__0");
					put(grammarAccess.getKategorieAccess().getGroup_2(), "rule__Kategorie__Group_2__0");
					put(grammarAccess.getBuchungAccess().getGroup_0(), "rule__Buchung__Group_0__0");
					put(grammarAccess.getBuchungAccess().getGroup_0_7_0(), "rule__Buchung__Group_0_7_0__0");
					put(grammarAccess.getBuchungAccess().getGroup_0_7_1(), "rule__Buchung__Group_0_7_1__0");
					put(grammarAccess.getBuchungAccess().getGroup_1(), "rule__Buchung__Group_1__0");
					put(grammarAccess.getEmpfaengerAccess().getGroup(), "rule__Empfaenger__Group__0");
					put(grammarAccess.getEmpfaengerAccess().getGroup_2(), "rule__Empfaenger__Group_2__0");
					...
					put(grammarAccess.getIntervallAccess().getMonateAssignment_3(), "rule__Intervall__MonateAssignment_3");
					put(grammarAccess.getIntervallAccess().getMonateAssignment_4_1(), "rule__Intervall__MonateAssignment_4_1");
					put(grammarAccess.getKategorieAccess().getNameAssignment_1(), "rule__Kategorie__NameAssignment_1");
					put(grammarAccess.getKategorieAccess().getBeschreibungAssignment_2_1(), "rule__Kategorie__BeschreibungAssignment_2_1");
					put(grammarAccess.getBuchungAccess().getNameAssignment_0_1(), "rule__Buchung__NameAssignment_0_1");
					put(grammarAccess.getBuchungAccess().getKontoAssignment_0_4(), "rule__Buchung__KontoAssignment_0_4");
					put(grammarAccess.getBuchungAccess().getBetragAssignment_0_6(), "rule__Buchung__BetragAssignment_0_6");
					put(grammarAccess.getBuchungAccess().getEmpfaengerAssignment_0_7_0_1(), "rule__Buchung__EmpfaengerAssignment_0_7_0_1");
					put(grammarAccess.getBuchungAccess().getVonAssignment_0_7_1_1(), "rule__Buchung__VonAssignment_0_7_1_1");
					put(grammarAccess.getBuchungAccess().getIntervallAssignment_0_9(), "rule__Buchung__IntervallAssignment_0_9");
					put(grammarAccess.getBuchungAccess().getKategorieAssignment_1_2(), "rule__Buchung__KategorieAssignment_1_2");
					put(grammarAccess.getEmpfaengerAccess().getNameAssignment_1(), "rule__Empfaenger__NameAssignment_1");
					put(grammarAccess.getEmpfaengerAccess().getStrasseAssignment_2_2(), "rule__Empfaenger__StrasseAssignment_2_2");
					put(grammarAccess.getEmpfaengerAccess().getPlzAssignment_2_4(), "rule__Empfaenger__PlzAssignment_2_4");
					put(grammarAccess.getEmpfaengerAccess().getOrtAssignment_2_6(), "rule__Empfaenger__OrtAssignment_2_6");
					put(grammarAccess.getEmpfaengerAccess().getBemerkungAssignment_2_8(), "rule__Empfaenger__BemerkungAssignment_2_8");
