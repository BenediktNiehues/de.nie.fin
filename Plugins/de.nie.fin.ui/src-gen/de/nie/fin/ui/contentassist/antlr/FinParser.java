		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBuchungAccess().getGroup_9(), "rule__Buchung__Group_9__0");
					put(grammarAccess.getBuchungAccess().getGroup_9_2(), "rule__Buchung__Group_9_2__0");
					put(grammarAccess.getKontaktAccess().getGroup(), "rule__Kontakt__Group__0");
					put(grammarAccess.getKontaktAccess().getGroup_2(), "rule__Kontakt__Group_2__0");
					put(grammarAccess.getKontaktAccess().getGroup_2_1(), "rule__Kontakt__Group_2_1__0");
					put(grammarAccess.getKontaktAccess().getGroup_2_1_2(), "rule__Kontakt__Group_2_1_2__0");
					put(grammarAccess.getKontaktAccess().getGroup_2_8(), "rule__Kontakt__Group_2_8__0");
					...
					put(grammarAccess.getKontoAccess().getKtoNrAssignment_4(), "rule__Konto__KtoNrAssignment_4");
					put(grammarAccess.getKontoAccess().getBlzAssignment_6(), "rule__Konto__BlzAssignment_6");
					put(grammarAccess.getKontoAccess().getBankAssignment_8(), "rule__Konto__BankAssignment_8");
					put(grammarAccess.getKontoAccess().getVerwendungAssignment_10(), "rule__Konto__VerwendungAssignment_10");
					put(grammarAccess.getKontoAccess().getInhaberAssignment_12(), "rule__Konto__InhaberAssignment_12");
					put(grammarAccess.getBuchungsintervallAccess().getNameAssignment_1(), "rule__Buchungsintervall__NameAssignment_1");
					put(grammarAccess.getBuchungsintervallAccess().getIntervallAssignment_3(), "rule__Buchungsintervall__IntervallAssignment_3");
					...
					put(grammarAccess.getBuchungAccess().getBuchIntervAssignment_8_1_1(), "rule__Buchung__BuchIntervAssignment_8_1_1");
					put(grammarAccess.getBuchungAccess().getKategorieAssignment_9_1(), "rule__Buchung__KategorieAssignment_9_1");
					put(grammarAccess.getBuchungAccess().getKategorieAssignment_9_2_1(), "rule__Buchung__KategorieAssignment_9_2_1");
					put(grammarAccess.getKontaktAccess().getNameAssignment_1(), "rule__Kontakt__NameAssignment_1");
					put(grammarAccess.getKontaktAccess().getKontenAssignment_2_1_1(), "rule__Kontakt__KontenAssignment_2_1_1");
					put(grammarAccess.getKontaktAccess().getKontenAssignment_2_1_2_1(), "rule__Kontakt__KontenAssignment_2_1_2_1");
					put(grammarAccess.getKontaktAccess().getStrasseAssignment_2_3(), "rule__Kontakt__StrasseAssignment_2_3");
					put(grammarAccess.getKontaktAccess().getPlzAssignment_2_5(), "rule__Kontakt__PlzAssignment_2_5");
					put(grammarAccess.getKontaktAccess().getOrtAssignment_2_7(), "rule__Kontakt__OrtAssignment_2_7");
					put(grammarAccess.getKontaktAccess().getBemerkungAssignment_2_8_1(), "rule__Kontakt__BemerkungAssignment_2_8_1");
