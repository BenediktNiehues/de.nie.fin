		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBuchungsintervallAccess().getMonateAssignment_4(), "rule__Buchungsintervall__MonateAssignment_4");
					put(grammarAccess.getBuchungsintervallAccess().getTagAssignment_6(), "rule__Buchungsintervall__TagAssignment_6");
					...
					put(grammarAccess.getBuchungAccess().getIntervallAssignment_9(), "rule__Buchung__IntervallAssignment_9");
					put(grammarAccess.getBuchungAccess().getKategorieAssignment_11(), "rule__Buchung__KategorieAssignment_11");
