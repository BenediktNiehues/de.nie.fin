...
* generated by Xtext
*/
package de.nie.fin.ui.contentassist.antlr;
...
public class FinParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.nie.fin.ui.contentassist.antlr.internal.InternalFinParser createParser() {
		de.nie.fin.ui.contentassist.antlr.internal.InternalFinParser result = new de.nie.fin.ui.contentassist.antlr.internal.InternalFinParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBuchungAccess().getAlternatives_7(), "rule__Buchung__Alternatives_7");
					put(grammarAccess.getBuchungAccess().getAlternatives_8(), "rule__Buchung__Alternatives_8");
					...
					put(grammarAccess.getMONATAccess().getAlternatives(), "rule__MONAT__Alternatives");
					put(grammarAccess.getBuchungsartAccess().getAlternatives(), "rule__Buchungsart__Alternatives");
					put(grammarAccess.getFinModelFileAccess().getGroup(), "rule__FinModelFile__Group__0");
					put(grammarAccess.getFinModelFileAccess().getGroup_0(), "rule__FinModelFile__Group_0__0");
					put(grammarAccess.getImportAccess().getGroup(), "rule__Import__Group__0");
					put(grammarAccess.getKontoAccess().getGroup(), "rule__Konto__Group__0");
					put(grammarAccess.getKontoAccess().getGroup_13(), "rule__Konto__Group_13__0");
					put(grammarAccess.getIntervallAccess().getGroup(), "rule__Intervall__Group__0");
					put(grammarAccess.getIntervallAccess().getGroup_3(), "rule__Intervall__Group_3__0");
					put(grammarAccess.getIntervallAccess().getGroup_3_1(), "rule__Intervall__Group_3_1__0");
					put(grammarAccess.getKategorieAccess().getGroup(), "rule__Kategorie__Group__0");
					put(grammarAccess.getBuchungsintervallAccess().getGroup(), "rule__Buchungsintervall__Group__0");
					put(grammarAccess.getBuchungAccess().getGroup(), "rule__Buchung__Group__0");
					put(grammarAccess.getBuchungAccess().getGroup_7_0(), "rule__Buchung__Group_7_0__0");
					put(grammarAccess.getBuchungAccess().getGroup_7_0_2(), "rule__Buchung__Group_7_0_2__0");
					put(grammarAccess.getBuchungAccess().getGroup_7_1(), "rule__Buchung__Group_7_1__0");
					put(grammarAccess.getBuchungAccess().getGroup_7_1_2(), "rule__Buchung__Group_7_1_2__0");
					put(grammarAccess.getBuchungAccess().getGroup_8_0(), "rule__Buchung__Group_8_0__0");
					put(grammarAccess.getBuchungAccess().getGroup_8_1(), "rule__Buchung__Group_8_1__0");
					put(grammarAccess.getBuchungAccess().getGroup_11(), "rule__Buchung__Group_11__0");
					put(grammarAccess.getBuchungAccess().getGroup_11_2(), "rule__Buchung__Group_11_2__0");
					put(grammarAccess.getKontaktAccess().getGroup(), "rule__Kontakt__Group__0");
					put(grammarAccess.getKontaktAccess().getGroup_12(), "rule__Kontakt__Group_12__0");
					...
					put(grammarAccess.getFinModelFileAccess().getNameAssignment_0_1(), "rule__FinModelFile__NameAssignment_0_1");
					put(grammarAccess.getFinModelFileAccess().getImportsAssignment_1(), "rule__FinModelFile__ImportsAssignment_1");
					put(grammarAccess.getFinModelFileAccess().getElementsAssignment_2(), "rule__FinModelFile__ElementsAssignment_2");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getKontoAccess().getNameAssignment_1(), "rule__Konto__NameAssignment_1");
					put(grammarAccess.getKontoAccess().getInhaberAssignment_4(), "rule__Konto__InhaberAssignment_4");
					put(grammarAccess.getKontoAccess().getKtoNrAssignment_6(), "rule__Konto__KtoNrAssignment_6");
					put(grammarAccess.getKontoAccess().getBlzAssignment_8(), "rule__Konto__BlzAssignment_8");
					put(grammarAccess.getKontoAccess().getBankAssignment_10(), "rule__Konto__BankAssignment_10");
					put(grammarAccess.getKontoAccess().getVerwendungAssignment_12(), "rule__Konto__VerwendungAssignment_12");
					put(grammarAccess.getKontoAccess().getBemerkungAssignment_13_1(), "rule__Konto__BemerkungAssignment_13_1");
					put(grammarAccess.getIntervallAccess().getTagAssignment_1(), "rule__Intervall__TagAssignment_1");
					put(grammarAccess.getIntervallAccess().getMonateAssignment_3_0(), "rule__Intervall__MonateAssignment_3_0");
					put(grammarAccess.getIntervallAccess().getMonateAssignment_3_1_1(), "rule__Intervall__MonateAssignment_3_1_1");
					put(grammarAccess.getKategorieAccess().getNameAssignment_1(), "rule__Kategorie__NameAssignment_1");
					put(grammarAccess.getBuchungsintervallAccess().getIntervallAssignment_1(), "rule__Buchungsintervall__IntervallAssignment_1");
					put(grammarAccess.getBuchungsintervallAccess().getNameAssignment_3(), "rule__Buchungsintervall__NameAssignment_3");
					put(grammarAccess.getBuchungAccess().getNameAssignment_1(), "rule__Buchung__NameAssignment_1");
					put(grammarAccess.getBuchungAccess().getKontoAssignment_4(), "rule__Buchung__KontoAssignment_4");
					put(grammarAccess.getBuchungAccess().getBetragAssignment_6(), "rule__Buchung__BetragAssignment_6");
					put(grammarAccess.getBuchungAccess().getEmpfaengerAssignment_7_0_1(), "rule__Buchung__EmpfaengerAssignment_7_0_1");
					put(grammarAccess.getBuchungAccess().getEmpfaengerKtoAssignment_7_0_2_1(), "rule__Buchung__EmpfaengerKtoAssignment_7_0_2_1");
					put(grammarAccess.getBuchungAccess().getVonAssignment_7_1_1(), "rule__Buchung__VonAssignment_7_1_1");
					put(grammarAccess.getBuchungAccess().getVonKtoAssignment_7_1_2_1(), "rule__Buchung__VonKtoAssignment_7_1_2_1");
					put(grammarAccess.getBuchungAccess().getIntervallAssignment_8_0_1(), "rule__Buchung__IntervallAssignment_8_0_1");
					put(grammarAccess.getBuchungAccess().getIntervallRefAssignment_8_1_1(), "rule__Buchung__IntervallRefAssignment_8_1_1");
					put(grammarAccess.getBuchungAccess().getBuchungsartAssignment_10(), "rule__Buchung__BuchungsartAssignment_10");
					put(grammarAccess.getBuchungAccess().getKategorieAssignment_11_1(), "rule__Buchung__KategorieAssignment_11_1");
					put(grammarAccess.getBuchungAccess().getKategorieAssignment_11_2_1(), "rule__Buchung__KategorieAssignment_11_2_1");
					put(grammarAccess.getKontaktAccess().getVornameAssignment_3(), "rule__Kontakt__VornameAssignment_3");
					put(grammarAccess.getKontaktAccess().getNachnameAssignment_5(), "rule__Kontakt__NachnameAssignment_5");
					put(grammarAccess.getKontaktAccess().getStrasseAssignment_7(), "rule__Kontakt__StrasseAssignment_7");
					put(grammarAccess.getKontaktAccess().getPlzAssignment_9(), "rule__Kontakt__PlzAssignment_9");
					put(grammarAccess.getKontaktAccess().getOrtAssignment_11(), "rule__Kontakt__OrtAssignment_11");
					put(grammarAccess.getKontaktAccess().getBemerkungAssignment_12_1(), "rule__Kontakt__BemerkungAssignment_12_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.nie.fin.ui.contentassist.antlr.internal.InternalFinParser typedParser = (de.nie.fin.ui.contentassist.antlr.internal.InternalFinParser) parser;
			typedParser.entryRuleFinModelFile();
